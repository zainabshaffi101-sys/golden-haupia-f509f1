        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://calendar.app.google/Z4oYFSa7hLMTdQdS6" target="_blank" rel="noopener noreferrer" className="text-sm transition-colors" style={{ color: 'rgba(43,37,39,0.6)' }}
                  onMouseEnter={(e) => (e.currentTarget as HTMLAnchorElement).style.color = '#4A1E2F'}
                  onMouseLeave={(e) => (e.currentTarget as HTMLAnchorElement).style.color = 'rgba(43,37,39,0.6)'}>
